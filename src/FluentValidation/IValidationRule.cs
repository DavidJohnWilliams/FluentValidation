...
namespace FluentValidation {
	...
	public interface IValidationRule {
		...
		void ApplyCondition(Func<IValidationContext<object>, bool> predicate, ApplyConditionTo applyConditionTo = ApplyConditionTo.AllValidators);
		...
		/// <param name="predicate">The condition to apply</param>
		/// <param name="applyConditionTo">Indicates whether the condition should be applied to all validators in the rule, or only the current one</param>
		void ApplyAsyncCondition(Func<IValidationContext<object>, CancellationToken, Task<bool>> predicate, ApplyConditionTo applyConditionTo = ApplyConditionTo.AllValidators);
