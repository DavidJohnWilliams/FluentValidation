...
namespace FluentValidation.Validators {
	...
	public abstract class EmailValidatorBase : PropertyValidator, IEmailValidator {
		internal EmailValidatorBase() {
	...
	[Obsolete("Regex-based email validation is not recommended and is no longer supported.")]
	public class EmailValidator : EmailValidatorBase, IRegularExpressionValidator, IEmailValidator {
	...
	public class AspNetCoreCompatibleEmailValidator : EmailValidatorBase, IEmailValidator {
